...
import org.thefempire.fempireapp.mail.EnvelopeService;
...
public class FempirePreferencesPage extends PreferenceActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addPreferencesFromResource(R.xml.fempire_preferences);
        ...
        e = findPreference(Constants.PREF_FEMPIRE_FILTERS);
        e.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            public boolean onPreferenceClick(Preference pref) {
                Intent nextActivity = new Intent(FempirePreferencesPage.this, FilterListActivity.class);
    ...
    protected void onResume() {
    	...
    	setRequestedOrientation(FempireSettings.Rotation.valueOf(
...
//        }
    	if (pref.getKey().equals(Constants.PREF_HOMEPAGE)) {
        	...
        	if (Constants.PREF_MAIL_NOTIFICATION_SERVICE_OFF.equals(objValue)) {
                ...
                // Tell the user about what we did.
                Toast.makeText(this, "Fempire mail will be checked: " +
