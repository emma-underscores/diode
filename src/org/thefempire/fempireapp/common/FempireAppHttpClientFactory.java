...
import org.thefempire.fempireapp.FempireApp;
...
public class FempireAppHttpClientFactory {
	
	private static final String TAG = "FempireAppHttpClientFactory";
...
//		        		new Scheme("https", getHttpsSocketFactory(), 443));
		    ...
		    protected SocketFactory getHttpsSocketFactory(){
				try {
			    	...
			    	Object sslSessionCache = sslSessionCacheClass.getConstructor(Context.class).newInstance(FempireApp.getApplication());
        ...
        httpclient.addRequestInterceptor(new HttpRequestInterceptor() {
            public void process(
            	...
            	FempireApp app = FempireApp.getApplication();
            	String version;
				try {
